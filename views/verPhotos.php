...
require '../conexion/conexion.php';  
        ...
        while ($nom= mysqli_fetch_array($nombre)){
            ...
            while ($arreidcloud2= mysqli_fetch_array($sql) )               //obtenemos un archivo y luego otro sucesivamente
                             {
                                if ($arreidcloud2['route_file'] == "/photos/") {
...
?>
<form action="funciones/subirPhoto.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Mis Fotos</h4>
                                </div>
                                            ...
                                            while ($arr= mysqli_fetch_array($sql23) )               //obtenemos un archivo y luego otro sucesivamente
                                                {
                                                    echo '<tr>';
                                                        echo '<td>
                                                         ...
                                                         echo '<td>
                                                         <input type="hidden"  id="22'.$arr['id_file'].'" value="'.$ruta2nivel.'">
